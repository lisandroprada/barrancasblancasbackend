...
export class CreateActivityDto {
  ...
  @IsString({ message: 'El próximo paso debe ser un texto.' })
  @IsOptional()
  proximoPaso?: string;
  ...
  @IsPhoneNumber('AR', {
    message:
      'El número de contacto debe ser un número de teléfono válido de Argentina.',
  })
  @IsOptional()
  numeroContacto?: string; // To store the number called/contacted

  // For EMAIL
  @IsString({ message: 'El asunto del email debe ser un texto.' })
  @IsOptional()
  ...
  @IsEmail(
    ...
    {
      message:
        'El destinatario del email debe ser una dirección de correo electrónico válida.',
    },
  )
  @IsOptional()
  ...
  @IsDateString(
    {},
    { message: 'La fecha programada debe ser una fecha y hora válidas.' },
  )
  @IsOptional()
  ...
  @IsDateString(
    ...
    {
      message:
        'La fecha de vencimiento de la tarea debe ser una fecha y hora válidas.',
    },
  )
  @IsOptional()
  ...
  @IsMongoId({
    message:
      'El ID del responsable de la tarea debe ser un ID de Mongo válido.',
  })
  @IsOptional()
